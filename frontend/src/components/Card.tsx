...
function Card({ experience ,onDelete}: { experience: any ,onDelete:any}) {
      ...
      <div className='p-4'>
        ...
        <div className='flex items-center justify-between'>
          ...
          {state.isAuthenticated ?(
            <button 
            className='bg-red-500 hover:bg-red-400 text-gray-1000 text-sm font-medium px-4 py-2 rounded-md'
            onClick={handle}
            >
              Delete
            </button>):("")
